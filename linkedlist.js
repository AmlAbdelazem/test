            ...
            //========================== To Insert In Tail ==============================
                ...
                var i=0 , x=i-1 , j=1;
                    var interV=setInterval(function(){
                        ...
                        linkedarr[i-1].style.color ="white";
...
var code_found=document.getElementById('found');
var code_not_found=document.getElementById('notfound');
var code_next=0;
...
function color()
{
    ...
    if(nodes.length > node_counter)
    {
        ...
        if(node_counter_prev>=0)
        {
            ...
            //nodes[node_counter_prev].style.backgroundColor='white';
            //nodes[node_counter_prev].style.color='#354a5f';
        }
